 ...
 * @param listener
 */
export declare function addLogInfoListener(listener: (logInfo: string) => void): import("react-native").EmitterSubscription;
/**
 * 添加消息撤回监听函数
 *
 * @param listener
 */
export declare function addRecallMessageListener(listener: (messageId: string) => void): import("react-native").EmitterSubscription;
/**
 * 同步会话阅读状态
 *
 ...
 * 添加消息监听函数
 */
export declare function addReceiveMessageListener(listener: (message: ReceiveMessage) => void): import("react-native").EmitterSubscription;
/**
 * 发送消息回调
 */
 ...
 * 添加输入状态监听函数
 */
export declare function addTypingStatusListener(listener: (status: TypingStatus) => void): import("react-native").EmitterSubscription;
/**
 * 设置消息发送状态
 *
 * @param messageId 消息 ID
 ...
 * 添加私聊阅读回执监听函数
 */
export declare function addReadReceiptReceivedListener(listener: (message: Message) => void): import("react-native").EmitterSubscription;
/**
 * 添加收到消息已读回执请求监听函数
 *
 ...
 */
export declare function addReceiptRequestListener(listener: (data: ReceiptRequest) => void): import("react-native").EmitterSubscription;
/**
 * 添加消息回执响应监听函数
 *
 * @param listener
 */
export declare function addReceiptResponseListener(listener: (data: ReceiptResponse) => void): import("react-native").EmitterSubscription;
/**
 * 取消发送中的媒体消息
 *
 * @param messageId 消息 ID
 ...
 * 添加连接状态监听函数
 */
export declare function addConnectionStatusListener(listener: (status: ConnectionStatus) => void): import("react-native").EmitterSubscription;
/**
 * 设置断线重连时是否踢出重连设备
 *
 ...
 * @param listener
 */
export declare function addPushArrivedListener(listener: (message: PushNotificationMessage) => void): import("react-native").EmitterSubscription;
